...
export default function Home() {
    // Dynamic SEO Metadata Injection for the First-Time Visitor Landing Page
    useEffect(() => {
        document.title = "FinTally | Track Your Finances Like a Pro - Smart Expense Tracker & AI Insights";
        ...
        metaDesc.content = "Manage your income, expenses, and financial insights in one sleek neon interface with FinTally. Fast, secure, and powered by intelligent analytics.";
        ...
        metaKeywords.content = "FinTally, personal finance tracker, expense manager, smart analytics, budget tracker, neon UI financial app";
    }, []);
    ...
    return (
        <div className="home-bg min-h-screen flex flex-col text-white">
            ...
            <main className="flex-1">
                {/* Hero Section */}
                <section className="flex flex-col items-center justify-center text-center px-4 animate-fadeInUp hero-section">
                ...
                <section className="py-16 px-6 text-center chatbot-section">
                    ...
                    <img
                        src={chatbotPreview}
                        alt="FinTally AI Chatbot Preview Interface"
